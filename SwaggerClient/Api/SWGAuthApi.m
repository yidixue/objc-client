...
@interface SWGAuthApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGAuthApi

NSString* kSWGAuthApiErrorDomain = @"SWGAuthApiErrorDomain";
NSInteger kSWGAuthApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) createUsingPOST1WithUsername: (NSString*) username
    ...
    if (username == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGAuthApiErrorDomain code:kSWGAuthApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/auth/{username}/create"];
